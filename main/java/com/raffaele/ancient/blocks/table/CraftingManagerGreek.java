 ...
 */
public class CraftingManagerGreek
{
    public static final CraftingManagerGreek instance = new CraftingManagerGreek();
    private List recipes = new ArrayList();
    
    public CraftingManagerGreek()
    {
                
    }
    
    public static CraftingManagerGreek getInstance() {
        return instance;
    }
